...
public class DmPreparedStatementNullSetterInstrumentation extends DmPrepareStatementInstrumentation {
    public final InstanceMethodsInterceptPoint[] getInstanceMethodsInterceptPoints() {
        return new InstanceMethodsInterceptPoint[]{(InstanceMethodsInterceptPoint) new JDBCPreparedStatementNullSetterInstanceMethodsInterceptPoint()};
    }
}
